...
Before contributing and if you are unsure about how the SDK or Checkout works you might want to read the documentation for [Klarna In-App SDK](https://developers.klarna.com/documentation/in-app/).
