...
| `xcode-12.0.1-fat` | fat | 12.0.1 - 12A7300 | 5.3| swiftlang-1200.0.29.2 clang-1200.0.30.1 |
| `xcode-12.0.1-slim` | slim | 12.0.1 - 12A7300 | 5.3| swiftlang-1200.0.29.2 clang-1200.0.30.1 |


## Cocoapods

This release defaults to using the latest, non-beta version `xcode-12.0.1-fat`. If you
want to use a different variant, update your Podfile to use a different subspec. E.g:


```ruby
pod 'KlarnaMobileSDK/xcode-10.3-fat', '~> 2.0.28'
```

```ruby
pod 'KlarnaMobileSDK/xcode-11.3.1-fat', '~> 2.0.28'
```

```ruby
pod 'KlarnaMobileSDK/xcode-11.7-fat', '~> 2.0.28'
```

```ruby
pod 'KlarnaMobileSDK/xcode-12.0.1-fat', '~> 2.0.28'
```
