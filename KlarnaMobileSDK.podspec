Pod::Spec.new do |s|
    ...
    s.subspec 'xcode-12.0-fat-full' do |sb|
        sb.source_files = "ios/full/xcode-12.0-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.public_header_files = "ios/full/xcode-12.0-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.vendored_frameworks = "ios/full/xcode-12.0-fat/KlarnaMobileSDK.framework"
    end
