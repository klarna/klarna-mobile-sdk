Pod::Spec.new do |s|
    ...
    s.subspec 'xcode-11.3.1-fat' do |sb|
    ...
    s.subspec 'xcode-12.1-fat' do |sb|
        sb.source_files = "ios/xcode-12.1-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.public_header_files = "ios/xcode-12.1-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.vendored_frameworks = "ios/xcode-12.1-fat/KlarnaMobileSDK.framework"
    end

    s.subspec 'xcode-12.1-fat-full' do |sb|
        sb.source_files = "ios/full/xcode-12.1-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.public_header_files = "ios/full/xcode-12.1-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.vendored_frameworks = "ios/full/xcode-12.1-fat/KlarnaMobileSDK.framework"
    end
    
    s.subspec 'xcode-12.2-fat' do |sb|
        sb.source_files = "ios/xcode-12.2-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.public_header_files = "ios/xcode-12.2-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.vendored_frameworks = "ios/xcode-12.2-fat/KlarnaMobileSDK.framework"
    end

    s.subspec 'xcode-12.2-fat-full' do |sb|
        sb.source_files = "ios/full/xcode-12.2-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.public_header_files = "ios/full/xcode-12.2-fat/KlarnaMobileSDK.framework/Headers/*.h"
        sb.vendored_frameworks = "ios/full/xcode-12.2-fat/KlarnaMobileSDK.framework"
    end
    

    s.default_subspec = 'xcode-12.2-fat'
